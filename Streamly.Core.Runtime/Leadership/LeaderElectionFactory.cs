    ...
    : ILeaderElectionFactory, IAsyncDisposable
{
    ...
    /// <summary>
    /// Retourne (ou crée) le service de leadership pour le stream donné.
    /// Thread-safe et idempotent. Doit être appelé depuis StartAsync des composants
    /// qui en dépendent — jamais depuis un constructeur (deadlock potentiel).
    /// </summary>
