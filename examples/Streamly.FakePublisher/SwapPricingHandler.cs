...
public class SwapPricingHandler
    : IStreamingRequestHandler<IrsRequest, IrsResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        await Task.Delay(rng.Next(0, 1_000), cancellationToken);
        ...
        while (!cancellationToken.IsCancellationRequested)
        {
            ...
            await Task.Delay(PublishInterval + TimeSpan.FromMilliseconds(rng.Next(0, 200)), cancellationToken);
        }
    }
