...
public class StreamlySettings
{
    ...
    {
        /// <summary>Interval at which the leader publishes heartbeats. Default: 100 ms.</summary>
        public int HeartbeatIntervalMs { get; set; } = 100;

        /// <summary>No heartbeat for this duration → leader considered dead. Default: 1000 ms.</summary>
