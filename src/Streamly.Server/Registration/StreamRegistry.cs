...
public class StreamRegistry : IStreamRegistry
{
    ...
    public StreamRegistry(StreamlyServerOptions options, ILogger<StreamRegistry> logger)
    {
    ...
    public string GetStreamName<TRequest>()
    {
        ...
        throw new InvalidOperationException(
            ...
            $"Call options.AddHandler<{requestType.Name}, TResponse, THandler>(\"streamName\") in AddStreamlyServer configuration.");
    }
